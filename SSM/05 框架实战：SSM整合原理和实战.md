...
5.  logback配置
    ...
    <configuration debug="true">
        ...
        <logger name="com.sdu.mybatis" level="DEBUG" />
...
@Configuration
@EnableWebMvc
@ComponentScan("com.sdu.controller")
 ...
 * 4. 声明@ComponentScan("com.sdu.service")注解,进行业务组件扫描
 * 5. 声明transactionManager(DataSource dataSource)方法,指定具体的事务管理器
 */
@EnableTransactionManagement
@EnableAspectJAutoProxy
@Configuration
@ComponentScan("com.sdu.service")
    ...
    3.  mybatis和持久层配置类
        ...
        public class MapperJavaConfig {
            ...
            public MapperScannerConfigurer mapperScannerConfigurer(){
                ...
                mapperScannerConfigurer.setBasePackage("com.sdu.mapper");
    ...
    2.  mapper配置类
        ...
        public class MapperJavaConfigNew {
            ...
            public SqlSessionFactoryBean sqlSessionFactoryBean(DataSource dataSource){
                ...
                //typeAliases
                sqlSessionFactoryBean.setTypeAliasesPackage("com.sdu.pojo");
...
1.  分页查询
    ...
    3.  mapper
        ...
        <!DOCTYPE mapper
                ...
                "https://mybatis.org/dtd/mybatis-3-mapper.dtd">
        <!-- namespace等于mapper接口类的全限定名,这样实现对应 -->
        <mapper namespace="com.sdu.mapper.ScheduleMapper">
