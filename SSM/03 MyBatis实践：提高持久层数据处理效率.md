...
3.  准备Mapper接口和MapperXML文件
    ...
    2.  定义mapper xml
        ...
        <mapper namespace="com.sdu.mapper.EmployeeMapper">
            ...
            <!-- 查询使用 select标签
                    ...
                    标签内编写SQL语句
             -->
            <select id="selectEmployee" resultType="com.sdu.pojo.Employee">
...
```xml
<select id="selectEmployee" resultType="com.sdu.mybatis.entity.Employee">
...
```xml
<!-- List<Employee> selectAll(); -->
<select id="selectAll" resultType="com.sdu.mybatis.entity.Employee">
...
3.  使用resultMap
    ...
    <resultMap id="selectEmployeeByRMResultMap" type="com.sdu.mybatis.entity.Employee">
...
4.  MapperXML编写
    ...
    <!DOCTYPE mapper
            ...
            "https://mybatis.org/dtd/mybatis-3-mapper.dtd">
    <!-- namespace等于mapper接口类的全限定名,这样实现对应 -->
    <mapper namespace="com.sdu.mapper.UserMapper">
      <!-- 定义一个插入语句，并获取主键值 -->
...
6.  效果测试
    ...
    import com.sdu.mapper.UserMapper;
    import com.sdu.pojo.User;
...
<select id="selectEmployeeByConditionByTrim" resultType="com.sdu.mybatis.entity.Employee">
...
<select id="selectEmployeeByConditionByChoose" resultType="com.sdu.mybatis.entity.Employee">
    select emp_id,emp_name,emp_salary from t_emp
    where
    <choose>
...
```.properties
sdu.dev.url=jdbc:mysql:///mybatis-example?allowMultiQueries=true
```
